  ...
  return (
    <div className="add-Transaction">
      <div className="header-modal">
        <img src={CloseIconM} id="CloseIconM" onClick={toggleModal} className="cursor-pointer" />
        <h4>افزودن تراکنش</h4>
        <img src={CloseIconD} id="CloseIconD" onClick={toggleModal} className="cursor-pointer" />
      </div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="date-input">
          <label>
            ...
            />
            {/* آیکون */}
            <img src={CalendarIcon} className="calendar-icon" onClick={openDatePicker} />
            {/* input واقعی date */}
            <input
              type="date"
              ref={dateRef}
        ...
        <div>
          <label>
            مبلغ (تومان)
            <input type="text" name="amount" value={formData.amount} onChange={inputChange} />
          </label>
